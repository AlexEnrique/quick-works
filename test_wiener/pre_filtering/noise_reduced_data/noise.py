...
samples = [str(n)+'.wav' for n in range(1, 16 + 1)]
...
for s in samples:
    ...
    # output_directory = '01_competition_noise_reduced/'
    output_directory = '03_flight_reduced/'
    output_file(output_directory ,filename, y_reduced_power, sr, '_pwr')
    # output_file(output_directory + '/ctr_s/' ,filename, y_reduced_centroid_s, sr, '_ctr_s')
    # output_file(output_directory + '/ctr_mb/' ,filename, y_reduced_centroid_mb, sr, '_ctr_mb')
    # output_file(output_directory + '/mfcc_up/' ,filename, y_reduced_mfcc_up, sr, '_mfcc_up')
    # output_file(output_directory + '/mfcc_down/' ,filename, y_reduced_mfcc_down, sr, '_mfcc_down')
    # output_file(output_directory + '/median/' ,filename, y_reduced_median, sr, '_median')
    # output_file(output_directory + '/org/' ,filename, y, sr, '_org')
